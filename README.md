...
- 🔐 **Автентифікуватись** через Google або GitHub OAuth
...
Код виконується через публічний [Judge0 CE API](https://judge0.com).
...
VITE_SANDBOX_API_URL=https://ce.judge0.com
```

`VITE_SANDBOX_API_URL` необов'язковий. Він потрібен лише якщо ви хочете спрямувати пісочницю на власний або альтернативний сумісний Judge0 endpoint.
...
Увімкніть потрібні OAuth-провайдери: **Authentication → Providers → Google** та, за потреби, **GitHub**.
...
- **Supabase** — PostgreSQL база даних + Google/GitHub OAuth
- **Judge0 CE API** — виконання коду на сервері
